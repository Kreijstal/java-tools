...
test('Enhanced Debug Features - Backtrace with method arguments', (t) => {
...
test('Enhanced Debug Features - Stack inspection', (t) => {
  const controller = new DebugController();
...
test('Enhanced Debug Features - Local variables inspection', (t) => {
  const controller = new DebugController();
...
test('Enhanced Debug Features - Specific local variable inspection', (t) => {
  const controller = new DebugController();
...
test('Enhanced Debug Features - Specific stack value inspection', (t) => {
  const controller = new DebugController();
...
test('Enhanced Debug Features - Negative stack indices', (t) => {
  const controller = new DebugController();
...
test('Enhanced Debug Features - Invalid indices handling', (t) => {
  const controller = new DebugController();
...
test('Enhanced Debug Features - Available variable names', (t) => {
  const controller = new DebugController();
