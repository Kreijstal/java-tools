...
module.exports = {
  ...
  methods: {
    ...
    'getVendor()Ljava/lang/String;': (jvm, obj) => {
      return readField(obj.fields, 'javax/sound/sampled/Mixer$Info')['vendor'];
    },
    'getDescription()Ljava/lang/String;': (jvm, obj) => {
      return readField(obj.fields, 'javax/sound/sampled/Mixer$Info')['description'];
    },
    'getVersion()Ljava/lang/String;': (jvm, obj) => {
      return readField(obj.fields, 'javax/sound/sampled/Mixer$Info')['version'];
    },
    'toString()Ljava/lang/String;': (jvm, obj) => {
      const info = readField(obj.fields, 'javax/sound/sampled/Mixer$Info');
